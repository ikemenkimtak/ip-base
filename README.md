...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ip-base)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/ip-base
```

A live public deployment of this template is available at [https://ip-base.templates.workers.dev](https://ip-base.templates.workers.dev)
